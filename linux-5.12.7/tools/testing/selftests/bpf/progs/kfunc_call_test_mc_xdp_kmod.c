...
extern int a_kmod_bpf_kfunc_call_test2(struct sock *sk, __u32 a, __u32 b) __ksym;
...
int kfunc_call_test2(struct xdp_md *ctx)
{
	...
	a = a_kmod_bpf_kfunc_call_test2((struct sock *)sk, 1, 2);

	char fmt[] = "MWC: xdp a_kmod_bpf_kfunc_call_test2() => '%llx'\n";
